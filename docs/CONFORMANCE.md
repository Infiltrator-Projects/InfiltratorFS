...
Release 0.18.7 accepts exactly current on-disk Format 0.12. Pre-1.0 builds do not promise compatibility with earlier development formats.
...
Release 0.18.7 qualifies this native migrated surface. Additional development qualification is expected to expand locking/concurrency, scale and stress coverage rather than reintroduce a FUSE runtime path.
