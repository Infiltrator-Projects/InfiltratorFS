...
Status: experimental writable prototype. Release 0.18.24 accepts exactly Format 0.17. Release 0.18.19 is the last Format 0.16 release. Pre-1.0 development builds do not promise compatibility with earlier development formats.
...
- Linux 0.18.24 development adapter xattrs/special-node metadata are not the final portable named-metadata/security model;
