...
Status: experimental writable prototype. Release 0.18.11 accepts exactly Format 0.12. Pre-1.0 development builds do not promise compatibility with any earlier development format, including 0.11.
...
- Linux 0.18.11 adapter xattrs/special-node metadata are not the final portable named-metadata/security model;
