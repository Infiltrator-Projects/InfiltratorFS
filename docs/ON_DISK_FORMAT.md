...
Status: experimental writable prototype. Development 0.18.19 accepts exactly Format 0.16. Release 0.18.18 is the last Format 0.15 release. Pre-1.0 development builds do not promise compatibility with earlier development formats.
