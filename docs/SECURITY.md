...
Release 0.18.4 stores POSIX mode and numeric UID/GID compatibility metadata and supports Linux `user.*` xattrs. Those facilities are useful today but are not yet the final portable principal/ACL store.
