...
#define INFILFS_ATTR_PROTECTION_COPIES_SHIFT 48u
#define INFILFS_ATTR_PROTECTION_COPIES_MASK ((__u64)0x00ff000000000000ULL)
#define INFILFS_ATTR_ENCRYPTION_DOMAIN_SHIFT 56u
#define INFILFS_ATTR_ENCRYPTION_DOMAIN_MASK ((__u64)0xff00000000000000ULL)
#define INFILFS_ATTR_STORAGE_POLICY_MASK \
    (INFILFS_ATTR_PROTECTION_COPIES_MASK | INFILFS_ATTR_ENCRYPTION_DOMAIN_MASK)
#define INFILFS_KNOWN_ATTR_FLAGS \
    (INFILFS_ATTR_READ_ONLY | INFILFS_ATTR_HIDDEN | INFILFS_ATTR_SYSTEM | \
     ...
     INFILFS_ATTR_NOT_CONTENT_INDEXED | INFILFS_ATTR_STORAGE_POLICY_MASK)
#define INFILFS_ATTR_PROTECTION_COPIES(flags) \
    ((__u8)(((flags) & INFILFS_ATTR_PROTECTION_COPIES_MASK) >> \
            INFILFS_ATTR_PROTECTION_COPIES_SHIFT))
#define INFILFS_ATTR_ENCRYPTION_DOMAIN(flags) \
    ((__u8)(((flags) & INFILFS_ATTR_ENCRYPTION_DOMAIN_MASK) >> \
            INFILFS_ATTR_ENCRYPTION_DOMAIN_SHIFT))
...
#define INFILFS_EXTENSION_VERSION 1u
#define INFILFS_EXTENSION_FLAG_REPARSE         0x0001u
#define INFILFS_EXTENSION_FLAG_PRESERVE_OPAQUE 0x0002u
#define INFILFS_KNOWN_EXTENSION_FLAGS \
    (INFILFS_EXTENSION_FLAG_REPARSE | INFILFS_EXTENSION_FLAG_PRESERVE_OPAQUE)

struct infilfs_extension_payload_disk {
    __le16 version;
    __le16 flags;
    __le32 type_version;
    __le32 data_size;
