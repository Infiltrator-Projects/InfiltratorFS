 ...
 * consume N-1 cores independently. The implementation in infiltratorfs_cpu.c
 * derives the CPU-heavy worker budget exactly as
 * max(1, online physical cores - 1); SMT siblings do not inflate that budget.
 */
