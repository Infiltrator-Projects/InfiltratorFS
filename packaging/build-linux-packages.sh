...
for required in \
    ...
    'usr/share/applications/infiltratorfs-manager.desktop    'usr/lib/infiltratorfs/infiltratorfs-format-partition.nemo_action$' \
...
printf 'Built native Linux release packages:\n  %s\n  %s\n' "$deb_name" "$run_name"
 \
    'usr/share/icons/hicolor/scalable/apps/infiltratorfs-manager.svg    'usr/lib/infiltratorfs/infiltratorfs-format-partition.nemo_action$' \
    'usr/share/fonts/truetype/infiltratorfs/mb_corpo_a_cond_regular.ttf$' \
    'usr/share/fonts/truetype/infiltratorfs/mb_corpo_s_bold.ttf$' \
    'usr/share/fonts/truetype/infiltratorfs/mb_corpo_s_regular.ttf$' \
    "usr/src/infiltratorfs-${package_version}/dkms.conf$" \
...
printf 'Built native Linux release packages:\n  %s\n  %s\n' "$deb_name" "$run_name"
 \
    'usr/share/app-install/icons/infiltratorfs.svg    'usr/lib/infiltratorfs/infiltratorfs-format-partition.nemo_action$' \
    'usr/share/fonts/truetype/infiltratorfs/mb_corpo_a_cond_regular.ttf$' \
    'usr/share/fonts/truetype/infiltratorfs/mb_corpo_s_bold.ttf$' \
    'usr/share/fonts/truetype/infiltratorfs/mb_corpo_s_regular.ttf$' \
    "usr/src/infiltratorfs-${package_version}/dkms.conf$" \
