...
mkdir -p "$dkms_copy"
for file in Makefile infiltratorfs_core.c infiltratorfs_crypto.c infiltratorfs_security.c infiltratorfs_extension.c infiltratorfs_internal.h infiltratorfs_format.h     infiltratorfs_allocation_map.c infiltratorfs_allocation_publish.c     infiltratorfs_parallel_alloc.c     infiltratorfs_index_tree.c infiltratorfs_directory_tree.c     infiltratorfs_rw.inc infiltratorfs_rw_legacy.inc infiltratorfs_checksum_cache.c infiltratorfs_checksum_store.c infiltratorfs_locator_cache.c infiltratorfs_rw_data.inc     infiltratorfs_rw_namespace.inc infiltratorfs_read_cache.c     infiltratorfs_pagecache.c infiltratorfs_linux_meta_codec.c infiltratorfs_linux_meta.inc     infiltratorfs_defrag.inc infiltratorfs_ioctl.h; do
