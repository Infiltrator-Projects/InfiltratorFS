...
mkdir -p "$dkms_copy"
for file in Makefile infiltratorfs_core.c infiltratorfs_internal.h infiltratorfs_format.h     infiltratorfs_allocation_map.c infiltratorfs_allocation_publish.inc     infiltratorfs_parallel_alloc.c     infiltratorfs_index_tree.c infiltratorfs_directory_tree.inc     infiltratorfs_rw.inc infiltratorfs_rw_legacy.inc infiltratorfs_rw_data.inc     infiltratorfs_rw_namespace.inc infiltratorfs_rw_read_cache.inc     infiltratorfs_pagecache.inc infiltratorfs_linux_meta.inc     infiltratorfs_defrag.inc infiltratorfs_ioctl.h; do
