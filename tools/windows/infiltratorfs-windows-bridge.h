 ...
 * this mode. A temporary NTFS virtualization root is projected as a drive
 * letter; file data is hydrated directly from the portable InfiltratorFS
 * core and Windows modifications are committed back on close.
 */
