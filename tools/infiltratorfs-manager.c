...
#include "manager/infiltratorfs-manager-storage.h"
...
static void manager_apply_theme(Manager *manager)
{
    ...
    g_string_append_printf(css,
        ...
        "stackswitcher button { background: transparent; color: %s; border-color: transparent; border-radius: 0; min-height: 30px; padding: 5px 10px; }\n"
