...
**Current release:** 0.18.24 (Format 0.17)<br>
...
```bash
chmod +x infiltratorfs-0.18.24-linux-native.run
./infiltratorfs-0.18.24-linux-native.run --dry-run
```
