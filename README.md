...
**Current release:** 0.18.22 (Format 0.17)<br>
...
```bash
chmod +x infiltratorfs-0.18.22-linux-native.run
./infiltratorfs-0.18.22-linux-native.run --dry-run
```
