...
**Current release:** 0.18.31 (Format 0.17)<br>
...
```bash
chmod +x infiltratorfs-0.18.31-linux-native.run
./infiltratorfs-0.18.31-linux-native.run --dry-run
```
