...
**0.18.38 release focus:** partition-safe Nemo/Linux Mint formatting, smoother native durability publication, pressure-aware CoW batching, and the associated mounted qualification fixes.<br>
