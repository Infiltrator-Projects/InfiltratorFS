...
**Current release:** 0.18.25 (Format 0.17)<br>
...
```bash
chmod +x infiltratorfs-0.18.25-linux-native.run
./infiltratorfs-0.18.25-linux-native.run --dry-run
```
