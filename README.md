...
**Current release:** 0.18.26 (Format 0.17)<br>
...
```bash
chmod +x infiltratorfs-0.18.26-linux-native.run
./infiltratorfs-0.18.26-linux-native.run --dry-run
```
