...
**Current source version:** 0.18.39 (Format 0.17)<br>
**0.18.39 release focus:** reliable Windows Explorer move-out from the driverless ProjFS bridge, including same-volume folder moves, recursive source removal and dedicated hosted-Windows regression qualification.<br>
